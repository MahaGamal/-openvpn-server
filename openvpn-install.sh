...
function removeUnbound() {
	...
	until [[ $REMOVE_UNBOUND =~ (y|n) ]]; do
		echo ""
		echo "If you were already using Unbound before installing  Maha's OpenVPN, I removed the configuration related to OpenVPN."
...
function manageMenu() {
	echo "Welcome to Maha's VPN-installer!"
	echo "It looks like  Maha's OpenVPN is already installed."
	echo ""
